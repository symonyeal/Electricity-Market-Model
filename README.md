...
## 4. External unit-commitment benchmark
...
A lossy read is always the cheaper program, which is what makes the gate sensitive:
...
Verification on 2026-09-15: 247 tests passed and 1 deselected; Ruff and dependency checks
passed; all benchmark rows completed, including the 2,082,896-row LP. The deselected test
clears the whole pglib-uc instance and is marked `slow`; it took 21 to 44 seconds
