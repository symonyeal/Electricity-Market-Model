...
[docs/results](docs/results/README.md) holds what the held-out year actually wrote. It is
a price-taking simulation against published prices, not evidence that these positions
could have been submitted, accepted or settled.
