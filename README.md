...
For line $(i,j)$, $f_{ij}=(\theta_i-\theta_j)/x_{ij}$ and
$-\bar f_{ij}\le f_{ij}\le\bar f_{ij}$. Nodal balances replace the single-system balance.

| Direct line limit | Bus 0 output | Bus 2 output | Cost | Price 0 | Price 1 | Price 2 | Congestion rent |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
